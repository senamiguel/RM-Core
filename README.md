<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/Release-Alpha--0.6.12-blue?style=flat" alt="Alpha-0.6.12">
...
2. Execute o instalador `RM-Core-Setup-Alpha-0.6.12.exe`.
...
O executável compilado será gerado em `installer/dist/RM-Core-Setup-Alpha-0.6.12.exe`.
